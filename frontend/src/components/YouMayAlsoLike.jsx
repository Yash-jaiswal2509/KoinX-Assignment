    ...
    return (
        <div className="p-10 sm:p-16 pb-24 mb-5 md:mb-0">
            ...
            <Carousel>
                <CarouselContent>
                    {sortCoins.flatMap((coin) => {
                        ...
                        const spanStyle = "p-1 ml-2 my-2 text-base flex items-center justify-center gap-1 rounded-md font-semibold";
                            ...
                            <CarouselItem key={coin.item.id} className="border-2 p-5 basis-4/5 sm:basis-3/5 md:basis-2/5 lg:basis-1/4 ml-4 rounded-2xl">
                                <div className="flex flex-col mr-10 gap-2">
                                    <div className="flex items-center gap-2 text-nowrap">
                                        ...
                                        <p className="font-semibold text-lg truncate min-w-16">{coin.item.name}</p>
                ...
                <CarouselNext className="w-12 h-12 -right-6 border-0 shadow-custom-light" />
                <CarouselPrevious className="w-12 h-12 -left-6 border-0 shadow-custom-light" />
            </Carousel>
            ...
            <Carousel>
                ...
                <CarouselNext className="w-12 h-12 -right-6 shadow-custom-light border-0" />
                <CarouselPrevious className="w-12 h-12 -left-6 shadow-custom-light border-0" />
            </Carousel>
